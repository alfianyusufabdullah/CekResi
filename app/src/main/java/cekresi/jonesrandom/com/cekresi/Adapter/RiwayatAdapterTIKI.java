...
public class RiwayatAdapterTIKI extends RecyclerView.Adapter<RiwayatHolder> {

    List<RiwayatItem> list;

    public RiwayatAdapterTIKI(List<RiwayatItem> list) {
        this.list = list;
    }
    ...
    public void onBindViewHolder(RiwayatHolder holder, int position) {
        ...
        holder.cart.setText("TIKI");
        holder.list_keterangan.setText(status);
